---
layout: single
title: "Nexacro_에_HttpOnly,_Secure_적용"
excerpt: "Nexacro_에_HttpOnly,_Secure_적용"
categories:
  - "tech"
tags:
  - "tech"
...
toc_sticky: true
date: "2026-09-22"
last_modified_at: "2026-09-22 16:25:44 +0900"
mermaid: false
---
## 1. 결론
...
# 4. `request.getSession()`에는 문제가 없는가?
...
# 5. Secure가 Nexacro에서 더 주의가 필요한 이유
...
# 7. Nexacro 자체 Cookie와 JSESSIONID를 구분해야 한다
...
# 11. SSV 세션 만료는 SSV 형식으로 처리하는 것이 좋다
...
# 16. 현재 JBoss EAP 7.2 환경에서 `web.xml` 적용 범위
